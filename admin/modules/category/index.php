<?php 
    ...
    $sql= " SELECT  category.*, category.name as namecate FROM category ";
                                            ...
                                            <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 10%;">Home</th>
                                                ...
                                                <tbody>
                                                    <?php  
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="home.php?id=<?php echo $item['id'] ?>" class="btn btn-info btn-xs"><?php echo $item['home']==1 ? 'Hiển thị' : 'Không'; ?></a></td>
